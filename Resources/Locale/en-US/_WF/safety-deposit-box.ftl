...
safety-deposit-console-purchase-trial = Trial (2x2) - ${$cost}
safety-deposit-console-purchase-small = Small (2x3) - ${$cost}
safety-deposit-console-purchase-medium = Medium (2x4) - ${$cost}
safety-deposit-console-purchase-large = Large (3x3) - ${$cost}
